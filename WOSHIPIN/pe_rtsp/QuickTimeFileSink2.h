...
#ifndef _QUICKTIME_FILE_SINK2_HH
#define _QUICKTIME_FILE_SINK2_HH

#ifndef _MEDIA_SESSION_HH
#include "MediaSession.hh"
#endif

class QuickTimeFileSink2: public Medium {
public:
  static QuickTimeFileSink2* createNew(UsageEnvironment& env,
  ...
  //added by xinghua
	void WritePacket(void *pkt);

  unsigned numActiveSubsessions() const { return fNumSubsessions; }

private:
  QuickTimeFileSink2(UsageEnvironment& env, MediaSession& inputSession,
  ...
  virtual ~QuickTimeFileSink2();

  Boolean continuePlaying();//dont'use
